/*******************************************************************************
  ...
  INDI Davis Tempest_Weather Pro/Pro2/Vue Weather Driver
...
// We declare an auto pointer to Tempest_Weather.
std::unique_ptr<Tempest_Weather> vantage(new Tempest_Weather());

Tempest_Weather::Tempest_Weather()
{
    setVersion(CDRIVER_VERSION_MAJOR, CDRIVER_VERSION_MINOR);
}

const char *Tempest_Weather::getDefaultName()
{
    return (const char *)"LFAST Weather";
}

bool Tempest_Weather::initProperties()
{
...
bool Tempest_Weather::Handshake()
{
    return ack();
}

IPState Tempest_Weather::updateWeather()
{
